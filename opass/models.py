...
RAMP: Dict[str, List[float]] = {
    ...
    "Zevgolatio (A)": [0.50, 0.70, 1.90, 2.70],
    "Kiato (P)": [0.60, 0.80, 2.20, 3.10],
    "Derveni (A)": [0.90, 1.30, 3.40, 4.70],
    "Akrata (A)": [1.20, 1.70, 4.40, 6.20],
    "Kalavryta (A)": [1.70, 2.40, 6.00, 8.50],
    "Drepano (A)": [1.20, 1.70, 4.30, 6.10]
}
